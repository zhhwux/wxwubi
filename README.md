...
## 更新日志
- 7.20：新增根据中文词库批量生成五笔词的功能（在custom_phrase/user.txt放入词库，格式是每行一条中文短语。当不加编码时，重新部署或输入/wjjc即可生成五笔词写入文件，由形词开关控制；已有编码和权重不会覆盖，输入/zyj会把“文件简词”转为“永久简词”即固定在次选的简词，输入/zwj则相反）
